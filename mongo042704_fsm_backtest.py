...
class World(strategy):  #inherit from strategy class
    def init(self,datex,stra,collection,thres1,thres2,thres3,thres4):
        ...
        global i0,N0,pos,transact,price,indexP,volume,slip
...
filename = 'accPL_HPLOB_SZ002500_2015-12-08_042704lp_s1_'+str(thres1)+'_s2_'+str(thres2)+'.pdf'
filename = os.path.join(path, filename)
filename1 = 'vis_HPLOB_SZ002500_2015-12-08_042704lp_s1_'+str(thres1)+'_s2_'+str(thres2)+'.pdf'
filename1 = os.path.join(path, filename1)
filename2 = 'hist_HPLOB_SZ002500_2015-12-08_042704lp_s1_'+str(thres1)+'_s2_'+str(thres2)+'.pdf'
filename2 = os.path.join(path, filename2)

dateCol= ["2015-12-01","2015-12-02","2015-12-03","2015-12-04","2015-12-07",
          "2015-12-08","2015-12-09","2015-12-10"]
if __name__ == "__main__":
    for date in dateCol:
        start=timeit.default_timer()
        world = World()
        world.init(date,5,collection,2.4,2.3,0.8,0.02)
        world.run()
        world.addPL()
        #world.performance()
        #world.tradeVisual()
