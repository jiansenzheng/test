# -*- coding: utf-8 -*-
"""
Created on Mon Apr 25 00:10:26 2016
    ...
    def slopeStraHPVV(self,doc0,seriesLen,thres1,thres2,thres3,thres4):
        ...
        if (doc0.get("buy5")!=0) and (doc0.get("sale5")!=0):
            ...
            if len(volume)==0:
                ...
                volume = np.append(volume,doc0.get("vol")/iniV)
            indexP = np.append(indexP,i0)
            pos=pos+1
            if pos>=seriesLen+1:
                tradex = Trader()
...
global thres1,thres2,finalMoment,sl,tp,thres3,thres4
datex =  "2015-12-08"
#thres1=15.0
#thres2=7.0 
thres1=2.5
